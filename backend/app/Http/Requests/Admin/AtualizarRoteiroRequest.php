...
class AtualizarRoteiroRequest extends FormRequest
{
    /**
    ...
    /**
     * Regras de validação para atualização de roteiro.
     * O título é opcional (sometimes), mas obrigatório quando presente.
     * publicar_em permite datas passadas para publicação imediata.
     *
